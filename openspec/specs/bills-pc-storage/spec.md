# bills-pc-storage Specification

## Purpose
Gestión y almacenamiento persistente en LittleFS del historial de Pokémon recibidos por intercambio ("Bill's PC"), con soporte de edición, exportación/importación y recarga hacia la mesa de trade.
