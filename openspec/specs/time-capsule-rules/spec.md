# time-capsule-rules Specification

## Purpose
Reglas de validación y advertencias visuales para preservar la compatibilidad del protocolo de la Cápsula del Tiempo (Time Capsule) entre cartuchos de Generación I y Generación II.
