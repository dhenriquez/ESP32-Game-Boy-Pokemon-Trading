...
/* Game Boy Character Set Constants (English Gen I & Gen II) */
#define TERM_ 0x50
#define SPACE_ 0x7f
#define A_ 0x80
#define B_ 0x81
...
uint8_t pokemon_char_to_encoded(int byte);
char pokemon_encoded_to_char(uint8_t byte);

void pokemon_str_to_encoded_array(uint8_t* dest, const char* src, size_t n);
